...
class Material:
    def __init__(self, filepath):
        ...
        glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST_MIPMAP_LINEAR)  # Définit le filtre de minification de la texture
        ...
        with Image.open(filepath,mode="r") as image:
            image_width, image_height = image.size  # Obtient la taille de l'image
